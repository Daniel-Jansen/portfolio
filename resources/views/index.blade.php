...
<main class="bg-repeat flex justify-center flex-col items-center">
    <section class="w-full flex justify-center flex-col lg:flex-row">
        ...
        <div class="w-full p-6 lg:w-1/2">
            <span class="font-semibold text-[2.5rem]">Hello!</span><span class="material-symbols-outlined origin-bottom ml-3 -rotate-[26deg] skew-x-6 ease-in-out duration-200 hover:-skew-x-12 hover:rotate-[25deg]">hand_gesture</span><br>
            <p>The name's Daniël, what's your name internet stranger?</p>
            <input type="text" placeholder="John Doe" class="w-[150px] max-w-[250px] bg-transparent rounded border-b border-teal-900 p-0.5 mt-1 transition-[width] duration-300 focus:outline-none focus:w-full focus:border-x">
        </div>
